...
public class TestAgentBehavior_ch2_DP {
	...
	public static void setUp () throws Exception {
		...
		parms_ch2_p30.addParameter("Variant", "Variant", String.class, "p37", true);
		parms_ch2_p30.addParameter("numberOfAgents", "numberOfAgents", Integer.class, 1, true);
		...
		parms_ch2_p30.addParameter("AgentBehavior","AgentBehavior",String.class,"repast.simphony.demos.sugarscape2.agents.behaviors.AgentBehavior_ch2_DP",true);
		parms_ch2_p30.addParameter("SpaceBehavior","SpaceBehavior",String.class,"repast.simphony.demos.sugarscape2.agents.behaviors.SpaceBehavior_ch2_DP",true);
