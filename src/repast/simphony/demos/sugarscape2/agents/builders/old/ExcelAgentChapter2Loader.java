...
import repast.simphony.demos.sugarscape2.agents.behaviors.old.movement.MovementAbility;
import repast.simphony.demos.sugarscape2.agents.behaviors.old.vision.VisionAbility;
		...
		while(rowItr.hasNext()) {
			...
			try {
				...
				SugarAgent_ch2p30 a = new SugarAgent_ch2p30.Builder(Integer.valueOf(id))
						...
						.withSugarProperties(new AgentResource(initSugar, metabSugar))
						.build();
