...
import repast.simphony.demos.sugarscape2.agents.behaviors.AgentDiesFromAge;
...
public class DefaultSugarscapeBuilder implements ContextBuilder<Object>{
	...
	public Context<Object> build(Context<Object> context) {
		...
		if(this.chapter==2) {
			...
			else if (this.variant.equalsIgnoreCase("p37")) {
				System.out.println("Initializing Chapter 2, page 37");
				return(constructChapter2_p37());				
			}
		}
...
private SugarSpace_ch2 constructChapter2_p37() {
		...
		for(int i=0;i<n;i++) {
			...
			AgentDiesFromAge da = AgentDiesFromAge.fromRunenvParameters();
